...
CREATE TABLE "slugs" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "name" varchar(255), "sluggable_id" integer, "sequence" integer DEFAULT 1 NOT NULL, "sluggable_type" varchar(40), "scope" varchar(40), "created_at" datetime, "locale" varchar(255));
...
CREATE TABLE "refinery_settings" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "name" varchar(255), "value" text, "destroyable" boolean DEFAULT 't', "created_at" datetime, "updated_at" datetime, "scoping" varchar(255), "restricted" boolean DEFAULT 'f', "callback_proc_as_string" varchar(255), "form_value_type" varchar(255));
...
CREATE TABLE "roles" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "title" varchar(255));
INSERT INTO "roles" VALUES(1,'Refinery');
INSERT INTO "roles" VALUES(2,'Superuser');
CREATE TABLE "user_plugins" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "user_id" integer, "name" varchar(255), "position" integer);
...
CREATE TABLE "images" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "image_mime_type" varchar(255), "image_name" varchar(255), "image_size" integer, "image_width" integer, "image_height" integer, "created_at" datetime, "updated_at" datetime, "image_uid" varchar(255), "image_ext" varchar(255));
...
CREATE TABLE "page_parts" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "page_id" integer, "title" varchar(255), "body" text, "position" integer, "created_at" datetime, "updated_at" datetime);
...
CREATE TABLE "page_part_translations" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "page_part_id" integer, "locale" varchar(255), "body" text, "created_at" datetime, "updated_at" datetime);
...
CREATE TABLE "seo_meta" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "seo_meta_id" integer, "seo_meta_type" varchar(255), "browser_title" varchar(255), "meta_keywords" varchar(255), "meta_description" text, "created_at" datetime, "updated_at" datetime);
...
CREATE TABLE "page_translations" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "page_id" integer, "locale" varchar(255), "title" varchar(255), "custom_title" varchar(255), "created_at" datetime, "updated_at" datetime);
...
CREATE TABLE "resources" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "file_mime_type" varchar(255), "file_name" varchar(255), "file_size" integer, "created_at" datetime, "updated_at" datetime, "file_uid" varchar(255), "file_ext" varchar(255));
CREATE TABLE "blog_posts" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "title" varchar(255), "body" text, "draft" boolean, "published_at" datetime, "created_at" datetime, "updated_at" datetime, "user_id" integer, "cached_slug" varchar(255), "custom_url" varchar(255), "custom_teaser" text);
...
<br />');
CREATE TABLE "blog_comments" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "blog_post_id" integer, "spam" boolean, "name" varchar(255), "email" varchar(255), "body" text, "state" varchar(255), "created_at" datetime, "updated_at" datetime);
...
CREATE TABLE "blog_categories" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "title" varchar(255), "created_at" datetime, "updated_at" datetime, "cached_slug" varchar(255));
CREATE TABLE "blog_categories_blog_posts" ("blog_category_id" integer, "blog_post_id" integer);
CREATE TABLE "tags" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "name" varchar(255));
INSERT INTO "tags" VALUES(1,'test');
CREATE TABLE "taggings" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "tag_id" integer, "taggable_id" integer, "taggable_type" varchar(255), "tagger_id" integer, "tagger_type" varchar(255), "context" varchar(255), "created_at" datetime);
INSERT INTO "taggings" VALUES(1,1,1,'BlogPost',NULL,NULL,'tags','2011-08-17 13:22:18.017172');
CREATE TABLE "inquiry_settings" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "name" varchar(255), "value" text, "destroyable" boolean, "created_at" datetime, "updated_at" datetime);
CREATE TABLE "inquiries" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "name" varchar(255), "email" varchar(255), "phone" varchar(255), "message" text, "created_at" datetime, "updated_at" datetime, "spam" boolean DEFAULT 'f');
...
CREATE TABLE "portfolio_items" ("id" INTEGER PRIMARY KEY AUTO_INCREMENT NOT NULL, "title" varchar(255), "description" text, "screenshot_id" integer, "link" varchar(255), "published_at" datetime, "position" integer, "created_at" datetime, "updated_at" datetime);
